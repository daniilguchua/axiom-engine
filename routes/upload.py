...
from core.utils import InputValidator, build_vector_index, extract_text_from_pdf
...
def upload():
    ...
    try:
        ...
        return jsonify(
            {"filename": safe_filename, "pages": page_count, "chunks": chunk_count, "session_id": session_id}
        ), 200
